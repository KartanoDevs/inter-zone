...
import { borrarRotacion, guardarFormacion, sistemaCompleto } from './sistema-recepcion';
...
function sistemaVacio(): Sistema {
  return { id: 'sistema-1', nombre: 'Sistema', tipo: 'recepcion', plantilla: plantilla(), formaciones: {} };
}
