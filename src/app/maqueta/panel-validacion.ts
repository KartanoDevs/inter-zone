 ...
 * a una pastilla compacta; no decide qué es infracción ni qué es aviso, eso ya viene
 * resuelto desde el dominio. No se muestra nada mientras falten jugadores por colocar
 * (ese estado lo enseña el banquillo) ni cuando la rotación es legal y limpia: solo
 * aparece cuando hay algo que decir.
 */
@Component({
  selector: 'mqt-panel-validacion',
  imports: [],
